<?php
	...
	class Main {
		...
		public function GetContent($con,$name_table,$category){
          	$result = mysqli_query($con,"SELECT * FROM $name_table WHERE category = $category
      ...
      public function init(){
        ...
        if ($this->page<1) 
        	$this->page=1;
        $result2 = mysql_query("SELECT * FROM image where category = 1");
		...
		function generate(){
            ...
            if($_SESSION["login"]==NULL){
          	...
          	$this->args['image'] = replaceArrayOfContent("tpl/galleryImage.tpl",constr($this->GetContent(Connect(),"image",1)));
