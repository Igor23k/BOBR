	...
	class Main {
		...
		public function GetContent($con,$name_table,$countRecord){
		 ...
		 public function generate(){
			$this->template = file_get_contents("tpl/news.tpl");
            ...
            if($_SESSION["login"]==NULL){
          	...
          	if (($_SESSION['permission'] & U_ALL) == U_ALL) {
                 $this->args['addNewsLink'] =  file_get_contents("tpl/addNewsLink.tpl");
            }
            else{
              	$this->args['addNewsLink'] ="";
            }
          	$this->args['loginArea'] = file_get_contents("tpl/loginArea.tpl"); 
          	$this->args['newsBlock'] = replaceArrayOfContent("tpl/oneNewsBlockInNews.tpl",constr($this->GetContent(Connect(),"news")));
