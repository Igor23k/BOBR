...
class ecomment {
	...
	private $flood_control = 1; //контроль флуда, в секундах. Время, которое должно пройти между публикациями одного автора. Ноль для отключения.
	...
	private $password = 'adminBOBRchess'; //пароль администратора. Рекомендуется сменить после установки.
	...
	private $mail_target = 'igorkozlov23@bk.ru'; //адреса, на которые будут отправляться уведомления (через запятую)
